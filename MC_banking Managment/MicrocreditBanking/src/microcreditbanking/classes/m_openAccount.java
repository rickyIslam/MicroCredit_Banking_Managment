 ...
 * @author Ricky Islam
 */
public class m_openAccount extends javax.swing.JFrame {

    /**
     * Creates new form openAccount
     */
    public m_openAccount() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton3.setText("Generate Acc No. & Date");
        ...
        jButton3.setBounds(520, 120, 260, 80);
        ...
        jLabel12.setText("Name Of Center :");
        jPanel1.add(jLabel12);
        jLabel12.setBounds(790, 220, 230, 42);
        ...
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "1/D", "1/M", "1/C", " ", " ", " " }));
        ...
        jComboBox4.setBounds(1020, 220, 80, 30);
        ...
        jLabel2.setText("Create A New Microcredit Account");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(220, 30, 970, 70);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       birth  = (" " + bdate + " - " + bmonth +" - " + byear ); 
        ...
        if ((date.isEmpty() || ac.isEmpty() || name.isEmpty() || birth.isEmpty() || phone.isEmpty() || occupation.isEmpty() || nid.isEmpty() || address.isEmpty() || sex.isEmpty() || type.isEmpty() || income.isEmpty() || nominee.isEmpty()))   {
...
stmt.executeQuery ("INSERT INTO microcredit_customer " + " VALUES (' "+date+" ', '"+ac+"', '"+name+"', '"+birth+"', '"+phone+"',' "+occupation+" ', '"+nid+"', '"+address+"', '"+sex+"', '"+type+"', '"+key+"', ' "+income+" ', '"+nominee+"')");  
...
jTextField1.setText(currentDate);
     ...
     */
    public static void m_openAccountFunction () {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(m_openAccount.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new m_openAccount().setVisible(true);
            }
        });
    }
