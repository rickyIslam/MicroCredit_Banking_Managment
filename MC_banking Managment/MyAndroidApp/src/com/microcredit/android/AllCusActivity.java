...
public class AllCusActivity extends Activity {
	private String keyword;
	private static final String SEARCH_URL = "http://10.0.2.2/mc_bank/allaccount.php";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_all_cus);
...
//							info.add(b.toString());
	...
	Handler handler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			pd.dismiss();
			if (msg.what == SUCCESS) {
				adapter = new ArrayAdapter<String>(AllCusActivity.this,
						R.layout.cus, R.id.search_text, info);
